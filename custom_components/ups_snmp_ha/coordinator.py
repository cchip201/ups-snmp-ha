...
UPS_MIB_OIDS: dict[str, dict[str, Any]] = {
    ...
    "environmental_temperature_1": {
        "oids": ["1.3.6.1.4.1.318.1.1.25.1.2.1.6.1.1", "1.3.6.1.4.1.318.1.1.10.2.3.2.1.4.1"]
    },
    "environmental_temperature_1_name": {
        "oids": ["1.3.6.1.4.1.318.1.1.25.1.2.1.3.1.1", "1.3.6.1.4.1.318.1.1.10.2.3.2.1.2.1"]
    },
    "environmental_temperature_2": {
        "oids": ["1.3.6.1.4.1.318.1.1.25.1.2.1.6.2.1", "1.3.6.1.4.1.318.1.1.10.2.3.2.1.4.2"]
    },
    "environmental_temperature_2_name": {
        "oids": ["1.3.6.1.4.1.318.1.1.25.1.2.1.3.2.1", "1.3.6.1.4.1.318.1.1.10.2.3.2.1.2.2"]
    },
